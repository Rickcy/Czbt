...
<? if ($model->image) : ?>
    <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
        <!-- slide background -->
        <img src="<?= $model->image->src; ?>" class="ls-bg" style="width: 100%;text-align: center"  alt="Slide background"/>
        ...
        <div class=" ls-l " style="width:auto; top:30px; left:0;   position:absolute;     "
            ...
            <div class="col-xs-12 col-md-6 c-white" style="background-color: rgba(41, 82, 93, 0.7); max-height:10px; overflow:hidden; margin-left: 60px;">
