...
HTML
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <a href="http://metrika.yandex.ru/stat/?id=23068939&amp;from=informer"
               target="_blank" rel="nofollow"><img src="//bs.yandex.ru/informer/23068939/3_1_FFFFFFFF_EFEFEFFF_0_pageviews"
                                                   style="width:88px; height:31px; border:0;" alt="Яндекс.Метрика" title="Яндекс.Метрика: данные за сегодня (просмотры, визиты и уникальные посетители)" onclick="try{Ya.Metrika.informer({i:this,id:23068939,lang:'ru'});return false}catch(e){}"/></a>
        </div>
    </div>
</footer>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter23068939 = new Ya.Metrika({id:23068939,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/23068939" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
